              ...
              <section className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <FeaturedAppCard 
                    ...
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/12cd0679-f352-498e-a6ad-9faaa1ffbec9.png"
                    isNew
                  />
                  <FeaturedAppCard 
                    title="Ultimate Upscale"
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/d16f3783-6af1-4327-8936-c5a50eb0cab5.png"
                  />
                  <FeaturedAppCard 
                    title="AI Filters"
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/142dea30-a410-4e79-84d0-70189e8fcd07.png"
                  />
                  <FeaturedAppCard 
                    title="Sketch to image"
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/b67f802d-430a-4e5a-8755-b61e10470d58.png"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
                  <FeaturedAppCard 
                    title="Blend Board"
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/4255fa40-8036-4424-a210-e3bcd99754df.png"
                  />
                  <FeaturedAppCard 
                    title="Change Facial Expression"
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/0c6db754-b805-46e5-a4b8-319a9d8fef71.png"
                  />
                  <FeaturedAppCard 
                    title="Expand"
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/8827d443-a68b-4bd9-998f-3c4c410510e9.png"
                  />
                  <FeaturedAppCard 
                    title="Remove background"
                    subtitle="By OpenArt"
                    imageSrc="/arpit-uploads/b89881e6-12b4-4527-9c22-1052b8116ca9.png"
                  />
                </div>
              ...
              <section className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <ModelCard 
                    title="OpenArt SDXL"
                    subtitle="OpenArt"
                    imageSrc="/arpit-uploads/22f4141e-f83e-4b85-8c93-672e181d999b.png"
                    tags={[
                  ...
                  <ModelCard 
                    title="Flux (dev)"
                    subtitle="Flux_dev"
                    imageSrc="/arpit-uploads/e9db2be9-f0a3-4506-b387-ce20bea67ba9.png"
                    tags={[
                  ...
                  <ModelCard 
                    ...
                    imageSrc="/arpit-uploads/e565a3ea-dc96-4344-a533-62026d4245e1.png"
                    tags={[
                      { label: 'Flux', variant: 'orange' },
